...
//  Blake2swift
//
//  Created by pebble8888 on 2019/01/20.
...
struct Blake2bp {
    ...
    static let PARALLELISM_DEGREE: Int = 4

/*
	static func blake2bp_init_leaf_param(s: inout blake2b_ctx, p: blake2b_param) -> Int
    {
    	let err: Int = blake2b_init_param(S, P);
    	S->outlen = P->inner_length
    	return err
    }

    static func blake2bp_init_leaf( blake2b_state *S, size_t outlen, size_t keylen, uint64_t offset ) -> Int
    {
    	blake2b_param P[1];
